// FILE: src/main/java/com/alperenulukaya/modules/TFlipFlopModule.java
package com.alperenulukaya.modules;

import java.util.Map;

import com.alperenulukaya.logic.T_FlipFlop; // Import the utility
...
/**
 * A UI module to demonstrate the behavior of a T (Toggle) Flip-Flop,
 * including a real-time timing diagram.
 */
public class TFlipFlopModule {
    ...
    private TimingDiagram timingDiagram; // New UI element
    ...
    private Pane createCircuitDiagram() {
        ...
        Text qNotText = new Text(260, 105, "Q'"); qNotText.setFont(Font.font(20)); qNotText.setFill(Color.WHITE);
